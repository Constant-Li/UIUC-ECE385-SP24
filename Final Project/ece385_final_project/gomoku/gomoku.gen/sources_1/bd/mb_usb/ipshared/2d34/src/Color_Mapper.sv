...
module  color_mapper ( input  logic [9:0]  DrawX, DrawY,                     
    ...
    begin
        ...
        // draw text "GOMOKU"
        else if ((DrawX >= 10'd295 && DrawX <= 10'd422) && (DrawY >= 10'd10 && DrawY <= 10'd41))
            begin
                text_inside_x = (DrawX - 10'd295) % 8;
                text_inside_y = (DrawY - 10'd10) % 16;
                
                // text_reg = "GOMO"
                text_reg = 32'h4f4d4f47;
                // extra_reg = "KU\\"
                extra_reg = 32'h0000554b;
                case((DrawX - 10'd295) >> 5)  // DrawX / 32
                    2'b00:
                        case((DrawX - 10'd295) >> 3)  // DrawX / 8
                            2'b00:
                ...
                text_addr = (text_blk << 4) + text_inside_y >> 1;
                
                if(text_data[7 - text_inside_x >> 1])
